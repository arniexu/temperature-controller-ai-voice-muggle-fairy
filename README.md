...
- I added support for both ARM Compiler (AC6) and Clang toolchains in parallel. AI helped generate the build files; I made sure they actually work together.
- The 5-layer software architecture (BSP → Drivers → UI Widgets → Domain → App) was my own design, done after the code was running.

**Timeline:** ~3 weeks, evenings and weekends.
